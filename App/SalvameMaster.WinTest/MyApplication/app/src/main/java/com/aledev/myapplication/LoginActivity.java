package com.aledev.myapplication;
...
import com.aledev.core.endpoints.IUsuarioEndpoint;
import com.aledev.core.entities.UsuarioDTO;
import com.aledev.core.model.AdminSQLiteOpenHelper;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, boolean> {
        ...
        protected boolean doInBackground(Void... params) {
            ...
            try {
                Call<UsuarioDTO> user = endPoint.getUserByLogon(mEmail, mPassword);
